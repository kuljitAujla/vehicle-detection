...
while True:
  ...
  # Line which dictates the tracking (draw once per frame, outside box loop)
  ...
  for r in results:
    ...
    for box in boxes:
      ...
      if class_name in allowed_classes and conf>0.30:
        ...
        if track_id is not None and limits[0] < cx < limits[2] and limits[1]-20 < cy < limits[1]+20:
          if track_id not in counted_ids:
            counted_ids.add(track_id)
            total_count += 1
            # Flash green line when counted
